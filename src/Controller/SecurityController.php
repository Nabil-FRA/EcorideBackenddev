...
use OpenApi\Attributes as OA; // On rajoute l'import
...
class SecurityController extends AbstractController
{
    ...
    /**
     * Connecte un utilisateur et retourne un token API.
     */
    #[OA\RequestBody(
    ...
    #[OA\Response(
        response: 400,
        description: "Données invalides (email/mot de passe manquant)."
    )]
